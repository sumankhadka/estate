...
<div class="row">
  <div class="col-md-12">
    ...
    <?php }?>
      ...
      <div class="row">
          <div class="col-md-7">
              <!-- add train line and station -->
              <div class="box">

                  <div class="box-title">
                      <h3><i class="fa fa-bars"></i><?php echo lang_key('train_line');?></h3>
                      <div class="box-tool">
                          <a href="#" data-action="collapse"><i class="fa fa-chevron-up"></i></a>
                      </div>
                  </div>
                  ...
                  <div class="box-content">
                    ...
                    <?php if(!$extra_stations):?>
                      <div class="text-right"><a href="javascript:void(0);" class="addanothertrainline btn btn-info " ><?php echo lang_key('add_another_trainline');?></a></div>  
                      <div class="form-group">
                          <label class="col-sm-4 col-lg-3 control-label"><?php echo lang_key('train_line');?>:</label>
                          <div class="col-sm-7 col-lg-8 controls">
                              <select name="trainline" id="trainline" class="form-control extra_trainlines">
                                  <?php foreach (get_all_trainlines()->result() as $row) {
                                      $v = (set_value('trainline')!='')?set_value('trainline'):$estate->trainline;
                                      $sel = ($row->id==$v)?'selected="selected"':'';
                                      ?>
                                      <option data-name="<?php echo $row->name;?>" value="<?php echo $row->id;?>" <?php echo $sel;?>><?php echo $row->name;?></option>
                                  <?php }?>
                      ...
                      <div class="form-group">
                        ...
                        <label class="col-sm-4 col-lg-3 control-label"><?php echo lang_key('station');?>:</label>
                        <div class="col-sm-7 col-lg-8 controls">
                            <input type="hidden" name="selected_station[]" id="selected_station" value="<?php echo(set_value('selected_station')!='')?set_value('selected_station'):'';?>">
                            <input type="text" id="station" name="station[]" value="<?php echo(set_value('station')!='')?set_value('station'):'';?>" placeholder="<?php echo lang_key('station');?>" class="form-control input-sm" >
                            <span class="help-inline station-loading">&nbsp;</span>
                            <?php echo form_error('station'); ?>
                           
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-4 col-lg-3 control-label">&nbsp;</label>
                        <div class="col-sm-7 col-lg-8 controls extrastation">
                            <a href="javascript:void(0);" class="addanother btn btn-info" style="margin-bottom:15px;"><?php echo lang_key('add_another');?></a><br/> 
                            <?php echo form_error('extra_station'); ?></div>
                      </div>
                    <?php else:?>
                        <?php foreach($extra_stations['trainlines'] as $extra_station):?>
                            <div>
                              <div class="box-content">
                                         <div class="text-right"><a href="javascript:void(0);" class="addanothertrainline btn btn-info " ><?php echo lang_key("add_another_trainline");?></a></div>
                                        <div class="form-group">
                                            <label class="col-sm-4 col-lg-3 control-label"><?php echo lang_key("train_line");?>:</label>
                                            <div class="col-sm-7 col-lg-8 controls">
                                                <select name="trainline[]" id="trainlinelk+'" class="form-control extra_trainlines">
                                                    <?php foreach (get_all_trainlines()->result() as $row) {?>
                                                        <?php $selected_trainline = ($row->id == $extra_station)?'selected="selected"':'';?>
                                                        <option value="<?php echo $row->id;?>" <?php echo $selected_trainline;?>><?php echo trim(strip_tags($row->name));?></option>
                                                    <?php }?>
                                                </select>
                                                <span class="help-inline">&nbsp;</span>                                               
                                            </div>
                                        ...
                                        <?php $station_count = 0;?>
                                        <?php $station_ids = $extra_stations[$extra_station]['station_id'];?>
                                        <?php foreach($extra_stations[$extra_station]['station_name'] as $stations):?>
                                        <div class="form-group">
                                            <label class="col-sm-4 col-lg-3 control-label"><?php echo lang_key("station");?>:</label>
                                            <div class="col-sm-7 col-lg-8 controls">
                                                <input type="hidden" name="selected_station[]" id="selected_extra_station'" value="<?php echo $station_ids[$station_count];?>">
                                                <input class="form-control input-sm ui-autocomplete-input extra_station" type="text" id="extra_stationlk+'" name="station[]" value="<?php echo $stations ?>" placeholder="station">
                                                <span class="help-inline extra_station_loading">&nbsp;</span>
                                                <?php if($station_count > 0):?>
                                                    <a href="javascript:void(0);" class="remove" style="margin-left:4px;color:#F00;font-weight:bold;">X</a>
                                                <?php endif;?>
                                            </div>
                                        </div>
                                        <?php $station_count++;?>
                              ...
                              <a href="javascript:void(0);" class="removetrainline" style="margin-left:4px;color:#F00;font-weight:bold;">Delete trainlineX</a>
                              </div>
                        <?php endforeach;?>
                    <?php endif;?>
                    <div class="extra_trainline"></div>
                  </div>
              </div>

              <!-- end train line and station -->
          </div>
          <div class="col-md-5">
               <!-- image box start -->
              <div class="box">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
      ...
      jQuery(document).on('click', '.addanother', function(){
          jQuery( '<div class="form-group"><label class="col-sm-4 col-lg-3 control-label"></label><div class="col-sm-7 col-lg-8 controls"><input type="hidden" name="selected_station[]" id="selected_extra_station'+lx+'" value=""><input class="form-control input-sm ui-autocomplete-input extra_station" type="text" id="extra_station'+lx+'" name="station[]" placeholder="station"><span class="help-inline extra_station_loading">&nbsp;</span>'+

           '<a href="javascript:void(0);" class="remove" style="margin-left:4px;color:#F00;font-weight:bold;">X</a></div></div>' ).insertBefore( $(this ).parent().parent('div') );
          // jQuery('.extrastation').append(

          // '<div><input type="hidden" name="selected_station[]" id="selected_extra_station'+lx+'" value=""><input class="form-control input-sm ui-autocomplete-input extra_station" type="text" id="extra_station'+lx+'" name="station[]" placeholder="station"><span class="help-inline extra_station_loading">&nbsp;</span>'+

          // '<a href="javascript:void(0);" class="remove" style="margin-left:4px;color:#F00;font-weight:bold;">X</a></div>');
        ...
        jQuery('#trainline').change(function(){
            jQuery('#station').val('');
            jQuery('#selected_station').val('');
            jQuery('.extra_station').val('');
            jQuery('.selected_extra_station').val('');
        });
        ...
        jQuery( "#station" ).bind( "keydown", function( event ) {
            if ( event.keyCode === jQuery.ui.keyCode.TAB &&
            jQuery( this ).data( "ui-autocomplete" ).menu.active ) {
                event.preventDefault();
            }
        ...
        .autocomplete({
            source: function( request, response ) {
                ...
                jQuery.post(
                    "<?php echo site_url('admin/realestate/get_station_ajax');?>/",
                    {term: request.term,trainline: jQuery('#trainline').val()},
                    function(responseText){
                        response(responseText);
                        jQuery('#selected_station').val('');
                        jQuery('.station-loading').html('');
                    },
                    "json"
                );
            },
            search: function() {
                ...
                {
                    jQuery('.station-loading').html('Loading...');
                }
            },
            focus: function() {
                // prevent value inserted on focus
            ...
            select: function( event, ui ) {
                this.value = ui.item.value;
                jQuery('#selected_station').val(ui.item.id);
                jQuery('.station-loading').html('');
                return false;
            }
        });
        ...
        // add new trainline
      var  lk= 1;
      jQuery(document).on('click', '.addanothertrainline', function(){
          
          jQuery('.extra_trainline').append(
          ...
          '<div class="box-content">'+
                    ...
                    '<div class="form-group">'+
                        ...
                        '<label class="col-sm-4 col-lg-3 control-label"><?php echo lang_key("train_line");?>:</label>'+
                        '<div class="col-sm-7 col-lg-8 controls">'+
                            '<select name="trainline[]" id="trainline'+lk+'" class="form-control extra_trainlines">'+
                                <?php foreach (get_all_trainlines()->result() as $row) {?>
                                    '<option value="<?php echo $row->id;?>"><?php echo trim(strip_tags($row->name));?></option>'+
                                <?php }?>
                            '</select>'+
                            '<span class="help-inline">&nbsp;</span>'+
                   ...
                   '</div>'+
                    ...
                    '<div class="form-group">'+
                        ...
                        '<label class="col-sm-4 col-lg-3 control-label"><?php echo lang_key("station");?>:</label>'+
                        '<div class="col-sm-7 col-lg-8 controls">'+
                            '<input type="hidden" name="selected_station[]" id="selected_extra_station'+lx+'" value=""><input class="form-control input-sm ui-autocomplete-input extra_station" type="text" id="extra_station'+lk+'" name="station[]" placeholder="station"><span class="help-inline extra_station_loading">&nbsp;</span>'+
                    ...
                    '</div>'+
                     ...
                     '<div class="form-group">'+
                        '<label class="col-sm-4 col-lg-3 control-label">&nbsp;</label>'+
                        '<div class="col-sm-7 col-lg-8 controls extrastation'+lk+'">'+
                            '<a href="javascript:void(0);" class="addanother btn btn-info" style="margin-bottom:15px;"><?php echo lang_key("add_another");?></a><br/>'+ 
          ...
          jQuery('.removetrainline').click(function(){
            jQuery(this).parent().remove();
          });
          lk++;
        })
        ...
        //for append station
        jQuery(document).on('keydown','.extra_station', function (event) { 
            if(!jQuery(this).data("autocomplete"))
            {
              $trainline_id = jQuery(this).parent().parent().parent().find('.extra_trainlines').val();
              jQuery(this) .autocomplete({
                  source: function( request, response ) {
                      
                      jQuery.post(
                          "<?php echo site_url('admin/realestate/get_station_ajax');?>/",
                          {term: request.term,trainline: $trainline_id},
                          function(responseText){
                              response(responseText);
                              jQuery(this).val('');
                              jQuery('.extra_station_loading').html('');
                          },
                          "json"
                      );
                  },
                  search: function() {
                      ...
                      {
                          jQuery('.extra_station_loading').html('Loading...');
                      }
                  },
                  focus: function() {
                      // prevent value inserted on focus
                  ...
                  select: function( event, ui ,id ) {
                      this.value = ui.item.value;
                      var selected_id = '#selected_'+this.id;
                      console.log(selected_id);
                      // jQuery(selected_id).val(ui.item.id);
