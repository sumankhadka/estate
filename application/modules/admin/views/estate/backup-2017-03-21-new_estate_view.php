            ...
            <div class="box">
                ...
                <div class="box-content">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7 col-lg-8 controls">
                            <select name="trainline" id="trainline" class="form-control">
      ...
      jQuery(document).on('click', '.addanothertrainline', function(){
          ...
          '<div class="box-content">'+
                    ...
                    '<div class="form-group">'+
                        ...
                        '<label class="col-sm-4 col-lg-3 control-label"><?php echo lang_key("train_line");?>:</label>'+
                        '<div class="col-sm-7 col-lg-8 controls">'+
                            '<select name="trainline" id="trainline'+lk+'" class="form-control">'+
                                '<?php foreach (get_all_trainlines()->result() as $row) {
                                    $sel = ($row->id==set_value("trainline"))?'selected="selected"':'';
                                    ?>'+
                                    '<option data-name="<?php echo $row->name;?>" value="<?php echo $row->id;?>" <?php echo $sel;?>><?php echo $row->name;?></option>'+
                   ...
                   '</div>'+
                    ...
                    '</div>'+
                     ...
                     '<div class="form-group">'+
                        ...
                        '<div class="col-sm-7 col-lg-8 controls extrastation">'+
                            '<a href="javascript:void(0);" class="addanother btn btn-info" style="margin-bottom:15px;"><?php echo lang_key("add_another");?></a><br/>'+ 
                            '<?php echo form_error("extra_station"); ?>'+
                         '</div>'+
                      '</div>'+
                    '<div class="extra_trainline"></div>'+
                '</div>'+
          '<a href="javascript:void(0);" class="removetrainline" style="margin-left:4px;color:#F00;font-weight:bold;">X</a>'+
          '</div>');
