        ...
        <table class="table table-hover">
           ...
           <thead>
               ...
               <tr>
                  ...
                  <th class="numeric"><?php echo lang_key('date');?></th>
          ...
          ?>
               ...
               <tr>
                  ...
                  <td data-title="<?php echo lang_key('date');?>" class="numeric"><?php echo date('Y-m-d',str_replace('query_email#','',$row->key));?></td>
                  ...
                  <td data-title="<?php echo lang_key('message'); ?>" class="numeric"><?php echo character_limiter(strip_tags($val->msg),40);?></td>
