                  ...
                  <div class="box-content">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-sm-7 col-lg-8 controls">
                              ...
                              <?php if(!empty($extra_station))
                              {
                                foreach ($extra_station as $key => $station) 
                                {
                               ?>
                                 <dir style="padding: 0;">
                                  <?php $selected_station = (set_value('selected_station')!='')?set_value('selected_station'):$estate->station;?>
                                    <input type="hidden" name="selected_station[]" id="selected_station" value="<?php echo $selected_station;?>">

                                  <input type="text" id="station" name="station[]" value="<?php echo $station;?>" placeholder="<?php echo lang_key('station');?>" class="form-control input-sm extra_station" >
                              ...
                              <dir class="extrastation" style="padding: 0;"></dir>
