        ...
        <div class="col-md-7">
            ...
            <div class="box">
                ...
                <div class="box-content">
                    ...
                    <div class="form-group">
                        <label class="col-sm-4 col-lg-3 control-label"><?php echo ('extra station');?>:</label>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $(document).bind('keydown','.extra_station', function (event) { 
            ...
            if (!jQuery(this).data("autocomplete") ) 
              { // If the autocomplete wasn't called yet:
                jQuery(this).autocomplete({
                    ...
                    select: function( event, ui ) {
                        this.value = ui.item.value;
                        jQuery('#selected_extra_station').val(ui.item.id);
                        jQuery('.extra_station_loading').html('');
                        return false;
                    }
                });
        ...
        jQuery(document).on('click', '.addanother', function(){
          jQuery('.extrastation').append(
                      '<div class="controls"><input type="hidden" name="selected_extra_station" id="selected_extra_station" value=""><span role="status" aria-live="polite" class="ui-helper-hidden-accessible"></span><input class="form-control extra_station ui-autocomplete-input" type="text" id="extra_station" name="extra_station[]" placeholder="station" autocomplete="off"><span class="help-inline extra_station_loading">&nbsp;</span>'+
