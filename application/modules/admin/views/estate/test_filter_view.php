...
<div style="display: block;">
    ...
    <label>Sales + Rent</label>
</div>
<h4><?php echo lang_key('type');?></h4>
<div style="display: block;">
...
<div style="display: block;">
    ...
    <select name="rent_price_unit">
        ...
        <option value="per_halfyear">Per Half Year</option>
...
<h4><?php echo lang_key('status');?></h4>
<div style="display: block;">
...
<h4>Facilities</h4>
<p>Will be checkbox for the system inputed facilities</p>


<h4>Address Filter</h4>
<h4>Country</h4>
<div style="display: block">
<select name="country[]" multiple="multiple" id="country" data-placeholder="Choose Country" ><option value="AF">Afghanistan</option>
