            ...
            <div class="box-content">
                <form action="<?php echo site_url('admin/widgets/widgetpositions')?>" method="post">
                    <div class="form-group">
                        <label class="col-sm-2 col-lg-1 control-label"><?php echo lang_key('widget_positions');?>:</label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4 col-lg-5 controls">
                            <button class="btn btn-primary" type="submit"><i class="fa fa-check"></i> <?php echo lang_key('show');?></button>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                </form>
