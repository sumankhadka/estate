        ...
        <div class="box">
            ...
            <div class="box-content">
                ...
                <div class="form-group">
                    <label class="col-sm-3 col-lg-2 control-label"><?php echo lang_key('select_template_file'); ?></label>
            ...
            <div class="clearfix"></div>
                ...
                if($email->num_rows()<=0)
                {
                    echo '<div class="alert alert-info input-xxlarge" style="margin-top:20px;">Select a template file and click edit</div>';
                }
                else
                {
                    $row = $email->row();
                    ...
                    <form class="form-horizontal" action="<?php echo site_url('admin/system/updateemail');?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-lg-10 controls">
                                <input type="text" name="subject" value="<?php echo (isset($values->subject))?$values->subject:set_value('subject');?>" placeholder="<?php echo lang_key('type_something');?>g" class="form-control" >
