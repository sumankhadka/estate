        ...
        <div class="box">
            ...
            <div class="box-content">
				...
				<form class="form-horizontal" action="<?php echo site_url('admin/system/translatelang');?>" method="post">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-2 control-label"><?php echo lang_key('target_lang_full_name'); ?></label>
                        <div class="col-sm-4 col-lg-5 controls">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-2 control-label"><?php echo lang_key('target_lang_short_name'); ?></label>
                        <div class="col-sm-4 col-lg-5 controls">
