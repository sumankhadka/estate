<div class="row"> 
  <div class="col-md-12">
    ...
    <div class="box">
      <div class="box-title">
        <h3><i class="fa fa-bars"></i>Create New Amenity</h3>
        <div class="box-tool">
      ...
      <div class="box-content">
        ...
        <form class="form-horizontal" id="addfacility" action="<?php echo site_url('admin/realestate/addfacility');?>" method="post">
        ...
        <div class="form-group">
          <label class="col-sm-2 col-lg-1 control-label">&nbsp;</label>
          <div class="col-sm-4 col-lg-5 controls">            
            <button class="btn btn-primary" type="submit"><i class="fa fa-check"></i> Create Amenity </button>
          </div>
        </div>
