    ...
    <div class="col-md-12">
        ...
        <div class="box">
            ...
            <div class="box-title">
                ...
                <h3><i class="fa fa-bars"></i> All Distance Fields</h3>
            ...
            <div class="box-content">    
                ...
                <a class="btn btn-primary" style="margin-bottom:15px;" href="<?php echo site_url('admin/realestate/new_distance_info'); ?>">Create a new distance field</a>

                <?php $this->load->helper('text'); ?>

                <?php if ($distance_infos->num_rows() <= 0) { ?>

                    <div class="alert alert-info">No Distance Fields</div>
                ...
                <form action="" method="post" id="all_facilities_form">
                    ...
                    <div id="no-more-tables">
                        ...
                        <table class="table table-hover">
                            ...
                            foreach ($distance_infos->result() as $row):
                                $val = json_decode($row->values);
                                ?>
                                ...
                                <tr>
                                    ...
                                    <td data-title="Icon" class="numeric"><img src="<?php echo base_url('uploads/thumbs/'.$val->{'icon'}); ?>" style="height: 16px;"></td>


                                    <td data-title="Title" class="numeric"><?php echo $val->{'title'}; ?></td>
                                    ...
                                    <td data-title="<?php echo lang_key('actions');?>" class="numeric">
                                        <div class="btn-group">
                                          ...
                                          <ul class="dropdown-menu dropdown-info">
                                              <li><a href="<?php echo site_url('admin/realestate/edit_distance_field/'.$row->id);?>"><?php echo lang_key('edit');?></a></li>
                                              <li><a href="<?php echo site_url('admin/realestate/remove_distance_field/'.$row->id); ?>">Remove</a></li>
                                          </ul>
                                        </div>
                                    </td>
...
<script type="text/javascript">
    ...
    jQuery('document').ready(function () {
        ...
        jQuery('#remove-selected').click(function(e){
            ...
            jQuery('#all_facilities_form').attr('action','<?php echo site_url("admin/realestate/remove_bulk_distance_fields");?>');
