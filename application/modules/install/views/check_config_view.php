<?php
	...
	$files = array(	'user_uploads','user_uploads/plugins','user_uploads/plugins/tmp','uploads',
					'uploads/profile_photos','uploads/profile_photos/thumb',
...

	{
...

		{
			...
			$error .= '<div class="alert alert-error">SITE_ROOT/'.$file.' is not writable.Please change it\'s permission before installing Realcon[ERROR].</div>';
...

	{
		...
		<p class="lead">Everything seems to be ok. Let's install Realcon with in 2 easy step :-)</p>
