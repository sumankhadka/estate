...
?>
        ...
        <div class="row">
              ...
              <div  class="orange-border panel panel-primary effect-helix in" id="advance_box">
                  ...
                  <div class="panel-body">
                      ...
                      <div class="info_list">
                          ...
                          $conditions = $this->config->item('property_status');
                          ?>
                          ...
                          <select id="condition-select" name="condition[]" class="form-control input-sm chzn-select" data-placeholder="Choose Status" multiple="multiple">
                              ...
                              <?php foreach ($conditions as $condition) {
                                  ...
                                  $sel = (in_array($condition['title'],$v))?'selected="selected"':'';
          ...
          <div class="col-md-9 col-sm-9"  style="-webkit-transition: all 0.7s ease-in-out; transition: all 0.7s ease-in-out;">
              ...
              <h1 class="detail-title"><i class="fa fa-building-o"></i>&nbsp;<?php echo lang_key('result'); ?> (<?php echo (isset($total_result))?$total_result:'';?>)
                      ...
                      <span id="facilities_container">
                        ...
                        <ul class="facilities-filter">
                            ...
                            else
                            {
                                ...
                                {
                                    $v = (is_array($filter_facilities))?$filter_facilities:array();
                            ...
                            ?>
                                    <li class="col-md-3 col-sm-9">
                                        <label>
                                            ...
                                            <input class="facility-filter" type="checkbox" name="facilities[]" value="<?php echo $facility->id;?>" <?php echo $sel;?>>
