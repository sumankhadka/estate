...
?>
            <div class="widget">
                ...
                <h2 class="recent-grid"><i class="fa fa-home"></i>&nbsp;<?php echo lang_key('top_estates');?></h2>
        ...
        <div class="view-more"><a class="" href="<?php echo site_url('show/properties/top');?>"><?php echo lang_key('view_all');?></a></div>
        <div class="clearfix"></div>
<?php } ?>