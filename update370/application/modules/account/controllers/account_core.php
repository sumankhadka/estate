...
class Account_core extends CI_Controller {
	...
	function newaccount($type='',$user_type='dealer')
	{
		if($user_type=='dealer')
	...
	function register()
	{
		...
		$this->form_validation->set_rules('user_type','user_type','required|xss_clean');
		$enable_pricing = get_settings('realestate_settings','enable_pricing','Yes');
        $send_confirm_email = get_settings('realestate_settings','enable_email_confirm','No');
	...
	function testemail()
	{
		$unique_id = '53cbcb0bea230';
		$userdata['user_type']	= 2;//2 = users
		$userdata['first_name'] = 'agent';
		$userdata['last_name'] 	= 'jhon';
		$userdata['gender'] 	= 'Male';			
		$userdata['user_name'] 	= 'agentjhon';
		$userdata['user_email'] = 'scmondal@dbcinfotech.com';
		$userdata['confirmed'] 	= 0;
		$userdata['status']		= 1;
